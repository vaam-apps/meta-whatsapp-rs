//! Reference code for the `meta-whatsapp-rs-testing` skill: testing code that uses
//! meta-whatsapp-rs without a network or a database — scripted Graph answers, the
...
//! (`crates/meta-whatsapp-rs/tests/skills.rs`). In your crate, `ScriptedTransport`
//! needs meta-whatsapp-rs's `testing` feature in dev-dependencies (see the skill).
