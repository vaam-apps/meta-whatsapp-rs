//! Reference code for the `wa-rs-token-vault` skill: merchants' business
...
pub fn open_vault(kv: Arc<dyn KvStore>, key_base64: &str) -> wa_rs::Result<TokenVault> {
...
) -> wa_rs::Result<Result<Client, NoMerchant>> {
...
pub async fn disconnect(vault: &TokenVault, waba_id: &WabaId) -> wa_rs::Result<bool> {
