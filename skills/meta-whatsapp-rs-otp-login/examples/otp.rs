//! Reference code for the `meta-whatsapp-rs-otp-login` skill: an authentication
...
use meta_whatsapp_rs::client::templates::TemplateCreated;
...
) -> meta_whatsapp_rs::Result<OtpService> {
    OtpService::new(
        client,
        phone_number_id,
...
pub async fn request_code(otp: &OtpService, user_input: &str) -> meta_whatsapp_rs::Result<Login> {
