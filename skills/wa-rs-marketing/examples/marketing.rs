//! Reference code for the `wa-rs-marketing` skill: opt-ins (In-App Signup
...
use wa_rs::client::analytics::{MessagingAnalyticsQuery, MessagingGranularity};
use wa_rs::client::marketing::{MarketingOptions, OnboardingStatus};
