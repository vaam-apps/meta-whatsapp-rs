//! Reference code for the `wa-rs-flows` skill: managing WhatsApp Flows
...
) -> wa_rs::Result<Result<FlowId, Vec<String>>> {
...
mod tests {
    ...
    fn unsigned_requests_are_refused_before_decryption() {
        ...
        let signed = wa_rs::webhooks::sign(&secrets[0], body);
