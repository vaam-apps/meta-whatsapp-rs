...
//!
//! ```no_run
//! # async fn demo(transport: impl wa_core::transport::HttpTransport) -> wa_core::Result<()> {
...
impl AppCredentials {
    ...
    pub fn app_token(&self) -> wa_core::secret::AccessToken {
        wa_core::secret::AccessToken::app_token(&self.app_id, &self.app_secret)
    }
}
