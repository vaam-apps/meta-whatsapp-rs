...
//!
//! ```no_run
//! # fn demo() -> Result<(), wa_core::error::ConfigError> {
//! use std::time::Duration;
//! use wa_adapters::http::ReqwestTransport;
//!
...
use wa_core::error::{ConfigError, TransportError};
...
impl ReqwestTransportBuilder {
    ...
    /// [`HttpRequest::timeout`]. Default: none. `wa-client` sets one on
