...
//! (`131047`).
//!
//! [`ValidationError`]: meta_whatsapp_core::error::ValidationError
//! [`ErrorKind::CustomerServiceWindowClosed`]: meta_whatsapp_core::ErrorKind::CustomerServiceWindowClosed
//!
//! ```no_run
...
//! ```no_run
//! # async fn demo(client: meta_whatsapp_client::Client) -> meta_whatsapp_core::Result<()> {
//! use meta_whatsapp_client::messages::{Header, OutboundMessage, ReplyButton, ReplyButtons};
//! use meta_whatsapp_core::recipient::Recipient;
//!
...
//! ```no_run
//! # async fn demo(client: meta_whatsapp_client::Client) -> meta_whatsapp_core::Result<()> {
//! use meta_whatsapp_client::messages::{FlowParameters, FlowRef, OutboundMessage};
//! use meta_whatsapp_core::recipient::Recipient;
//!
...
//! ```no_run
//! # async fn demo(client: meta_whatsapp_client::Client) -> meta_whatsapp_core::Result<()> {
//! use meta_whatsapp_client::messages::{OutboundMessage, ProductSection};
//! use meta_whatsapp_core::recipient::Recipient;
//!
...
/// [`Error::Decode`](meta_whatsapp_core::Error::Decode) context of [`Messages::send`].
...
impl Messages {
    ...
    /// as [`Error::Decode`](meta_whatsapp_core::Error::Decode) without the body or
