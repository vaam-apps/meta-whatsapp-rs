...
//! its ids are [`meta_whatsapp_core::ids::UploadSessionId`] and
//! [`meta_whatsapp_core::ids::UploadHandle`]).
//!
...
//!
//! ```no_run
//! # async fn demo(client: meta_whatsapp_client::Client, png: Vec<u8>) -> meta_whatsapp_core::Result<()> {
//! use meta_whatsapp_client::messages::{Image, OutboundMessage};
...
//!
//! ```no_run
//! # async fn demo(client: meta_whatsapp_client::Client) -> anyhow::Result<()> {
