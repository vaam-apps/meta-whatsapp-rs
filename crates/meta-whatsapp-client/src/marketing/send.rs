...
impl Marketing {
    ...
    /// with [`ErrorKind::MarketingNotAllowed`](meta_whatsapp_core::ErrorKind::MarketingNotAllowed)
    /// (`131055`, `134100`). A template created or unused for 7+ days needs
    /// ~10 minutes of ad sync first
    /// ([`ErrorKind::TemplateSyncing`](meta_whatsapp_core::ErrorKind::TemplateSyncing), `134101`).
    ///
