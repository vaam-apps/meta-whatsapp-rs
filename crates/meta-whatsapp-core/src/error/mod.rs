//! The `meta-whatsapp-rs` error tree.
//!
//! ```text
...
/// Result alias used by every `meta-whatsapp-rs` crate.
...
impl Error {
    ...
    /// sink and webhook errors are `false` too: meta-whatsapp-rs raises them before a
