...
//! `crates/meta-whatsapp-typst/tests/fixtures/`.
//!
...
//!
//! ```no_run
//! use meta_whatsapp_typst::{InvoiceInput, Renderer, Template};
//!
//! # fn run(input: InvoiceInput) -> meta_whatsapp_core::Result<()> {
...
//!
//! ```
//! use meta_whatsapp_typst::{Renderer, Template};
//!
//! # fn main() -> Result<(), meta_whatsapp_typst::RenderError> {
