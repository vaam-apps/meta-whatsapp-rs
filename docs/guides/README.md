...
| [server.md](server.md) | run the HTTP service for an app not written in Rust: configure it, create tenants and keys, call it | [`meta-whatsapp-server`](../../crates/meta-whatsapp-server/src/main.rs) | [`meta-whatsapp-rs-server`](../../skills/meta-whatsapp-rs-server/SKILL.md) |
