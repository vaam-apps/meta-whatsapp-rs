...
| 4 | Authentication templates (copy code, one-tap, zero-tap), previews, bulk upsert, OTP service (E.164-bound, scoped to the sending number and an optional namespace, hashed, CAS-counted attempts, cooldown + 5/hour issue limit) | very requested | `wa_client::authentication` | `templates/authentication-templates/*` | **done** |
